...
2. Tela de confirmação por e-mail (2FA) tem só uma saudação **"Olá DANIEL SOARES MENEZES"** como heading — o extrator pegava o nome do próprio usuário como se fosse o título da página. `NON_TITLE_HEADING_PATTERNS` ganhou `/^ola\b/`.
