...
**Método:** varredura via CDP de 2022–2026 do `EspelhoPontoMesAction_recuperar.action`, cruzando a coluna Ocorrência (`TRABALHO HIBRIDO`) com o rodapé (`Pecúnia`, `Horas Excedentes Homologadas`, `Horas Excedentes Não Homologadas`, `Horas Utilizadas do Banco`, `Resíduo de Horas`). Servidor 30000000.
